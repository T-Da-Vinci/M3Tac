...
# This code was copied from the `KAIR`
...
def define_G(opt):
    ...
    if net_type == 'acmixsr':
        from models.network_pacmixer_modify import ACMixSR as net
        netG = net(in_channels=opt_net['in_channels'],
                     sf=opt_net['sf'],
                     layer=opt_net['layer'],
                     hidden_channels=opt_net['hc'],
                     head=opt_net['head'],
                     kernel_att=opt_net['kernel_att'],
                     )
    
    elif net_type == 'pacmixsr':
    ...
    elif net_type == 'pacmixsr3':
        from models.network_pacmixer_modify import PACMixSR3 as net
        netG = net(in_channels=opt_net['in_channels'],
                     sf=opt_net['sf'],
                     hidden_channels=opt_net['hc'],
                     head=opt_net['head'],
