...
class ModelPlain(ModelBase):
    ...
    def save_better(self, avg_psnr):
        self.save_network(self.save_dir, self.netG, 'G', avg_psnr)
        if self.opt_train['E_decay'] > 0:
            self.save_network(self.save_dir, self.netE, 'E', avg_psnr)
        if self.opt_train['G_optimizer_reuse']:
            self.save_optimizer(self.save_dir, self.G_optimizer, 'optimizerG', avg_psnr)
